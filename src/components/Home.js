    ...
    <div>
        ...
        <div className="grid md:grid-cols-12 gap-10 items-center">
          ...
          <div className="space-y-4 order-2 md:order-1 md:col-span-7">
            ...
            <p className="text-gray-600 text-lg">
              ...
              development company in London (UK). We offer web and app design and
              development, graphic design, SEO and digital marketing solutions.
            </p>
            ...
            <p className="text-gray-600 text-lg">
              ...
              <p className="text-green-600 text-lg">
                Your website and data are safeguarded with the latest
                technologies and best practices, ensuring complete peace of mind
                for your business.
              </p>
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        <div className="text-center mb-12">
          <h3 className="text-blue-600 font-semibold text-3xl underline">
            Why Choose Us
          </h3>
          ...
          <div className="flex flex-col gap-6">
            <div className="p-6 rounded-lg shadow">
              ...
              <p className="text-gray-500">
                At <span className="font-semibold">Dev Hub Solutions</span>, our
                core expertise lies in{" "}
                <span className="text-black font-semibold">
                  Ruby on Rails, MERN, and MEAN
                </span>
                , delivering high-performance, future-ready solutions. We also
                bring proven mastery in{" "}
                <span className="text-black font-semibold">
                  Python, PHP, WordPress, AI &amp; LLM integration, and DevOps
                  automation
                </span>
                —making us your ultimate one-stop partner for innovative and
                scalable IT solutions. With cutting-edge skills and a
                results-driven approach, we help businesses thrive in today’s
            ...
            <div className="p-6 rounded-lg shadow">
              ...
              <p className="text-gray-500">
                We do not over promise we over-deliver our promise. We have a
                great collection of internal frameworks with best-in-class
                infrastructure with a decade of experience in the IT software
                development industry that helps us to deliver solutions with
                superior quality at all times. We have learned how to avoid
          ...
          <div className="flex flex-col gap-6 order-3">
            ...
            <div className="p-6 rounded-lg shadow">
              ...
              <p className="text-gray-500">
                ...
                your product and its feedback seriously. With this we make sure
                that we all are heading towards the right direction. Which saves
                really everything that matters.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto py-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-4">
              With over 11 years of experience in web design and development, Dev
              Hub Solutions stands as one of the major web development companies
              in London(UK) with a solid team of web designers, and developers.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 mt-4">
              With years of experience in mobile application development, Dev Hub
              Solutions can create user friendly mobile apps for both Android and
              iOS platforms.
            </p>
          </div>
          <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-4">
              ...
              the top of search rankings. Our powerful SEO strategies ensure your
              website dominates Google, Yahoo, Bing, and every major search
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="p-6 rounded-lg shadow hover:shadow-lg transition text-center">
            <ClipboardCheck
              size={40}
              className="text-white bg-blue-500 text-5xl mx-auto"
            />
